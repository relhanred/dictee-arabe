...
export default function LettersPage() {
    ...
    // Définir les colonnes spécifiques pour les lettres
    const columns = [
        { key: 'letter', header: 'Lettre', className: 'w-16 text-center' },
    ...
    useEffect(() => {
        ...
        // Filtrer pour n'avoir que les dictées de type "Lettre"
        const q = query(
            dictationsRef,
            where("type", "==", "Lettre"),
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-black">Lettres</h1>
                <button
